...
<Callout type="info" title="Need the concrete API paths?">
See the Tenant Onboarding Guide for exact endpoint paths, payloads, and the full non-SDK flow.
</Callout>
...
<Cards>
  <Card href="./docs/tenant-onboarding" title="Tenant Onboarding Guide">
    Full SDK + API onboarding with concrete endpoint examples.
  </Card>
  ...
  <Card href="./docs/authentication" title="Authentication & Tokens">
